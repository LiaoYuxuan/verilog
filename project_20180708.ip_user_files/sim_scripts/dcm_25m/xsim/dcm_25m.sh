...
#
# Generated by Vivado on Mon Jul 09 21:11:20 +0800 2018
...
# Script info
echo -e "dcm_25m.sh - Script generated by export_simulation (Vivado v2017.1 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dcm_25m xil_defaultlib.dcm_25m xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim dcm_25m -key {Behavioral:sim_1:Functional:dcm_25m} -tclbatch cmd.tcl -log simulate.log
}
