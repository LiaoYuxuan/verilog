...
#
# Generated by Vivado on Sun Jul 08 21:55:02 +0800 2018
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../project_20180708.srcs/sources_1/ip/clk_wiz_1" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../project_20180708.srcs/sources_1/ip/clk_wiz_1" \
    "$ref_dir/../../../../project_20180708.srcs/sources_1/ip/clk_wiz_1/clk_wiz_1_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
